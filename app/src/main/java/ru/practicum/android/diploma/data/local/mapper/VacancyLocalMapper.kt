...
class VacancyLocalMapper {
    ...
    /**
     * Преобразует domain модель вакансии в entity для БД избранного
     */
    fun toFavoritesEntity(domain: Vacancy): VacancyInFavoritesEntity {
    ...
    /**
     * Преобразует entity из БД избранного в domain модель вакансии
     */
